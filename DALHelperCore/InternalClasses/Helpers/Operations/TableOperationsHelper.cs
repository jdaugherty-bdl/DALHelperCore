...
namespace DALHelperCore.InternalClasses.Helpers.Operations
{
    internal class TableOperationsHelper
    {
        ...
        {
            var tableName = TableName ?? DALHelper.GetDalTable(ForceType) ?? throw new CustomAttributeFormatException(DatabaseCoreUtilities.NoDalTableAttributeError);
        ...
        {
            return DALHelper.GetDalTable(DalObjectType);
        }
    }
}
