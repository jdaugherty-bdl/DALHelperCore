using DALHelperCore.Interfaces;
...
namespace DALHelperCore.InternalClasses.Helpers.Context
{
    internal class DALContextHelper : IDALContext
    {
        ...
        {
            var tableName = DALHelper.GetDalTable(TableType) ?? throw new CustomAttributeFormatException(DatabaseCoreUtilities.NoDalTableAttributeError);
